...
// The constructor
HostObjectClass::HostObjectClass(Class nativeRef)
: m_nativeRef(nativeRef) {}

// Returns the value for any given property accessed.
jsi::Value HostObjectClass::get(jsi::Runtime& rt, const jsi::PropNameID& propName) {
  ...
  NSString *stringTag = [NSString stringWithFormat: @"HostObjectClass<%@>", NSStringFromClass(m_nativeRef)];
...
void HostObjectClass::set(jsi::Runtime& runtime, const jsi::PropNameID& propName, const jsi::Value& value) {
//  auto name = propName.utf8(runtime);
}

jsi::Function HostObjectClass::invokeMethod(jsi::Runtime &runtime, std::string methodName, SEL sel) {
...
//  Class clazz = m_type == HostObjectClassType::CLASS ? (Class)nativeRef : [nativeRef class];
  ...
  auto hostFunction = [this, reservedArgs, sel, observedReturnType, inv, jsCallInvoker] (jsi::Runtime& runtime, const jsi::Value& thisValue, const jsi::Value* arguments, size_t count) -> jsi::Value {
    ...
    // it as a HostObjectClass and pass that back to JS.
    // 
